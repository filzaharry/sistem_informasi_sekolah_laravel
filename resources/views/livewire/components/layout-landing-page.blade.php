...
<body>
    ...
    {{-- <div class="col-lg-10 bg-white mx-auto justify-content-center"> --}}
        ...
        <div class="container mt-4 pt-4 col-lg-10">
            ...
            <div class="row mb-2">
                <div class="col-md-6">
                    <div class="bg-white row g-0 border rounded overflow-hidden flex-md-row mb-4 position-relative">
