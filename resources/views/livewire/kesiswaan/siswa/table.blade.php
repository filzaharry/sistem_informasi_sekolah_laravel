            ...
            <div class="p-4">
                ...
                <div class="table-responsive border rounded p-1">
                    <table class="table align-items-center justify-content-center mb-0" style="font-size: 13px;">
                        <thead>
                            <tr>
                                <th class="font-weight-bolder">NIS</th>
                        ...
                        <tbody>
                            @foreach ($data as $a)
                                <tr>
                                    ...
                                    <td>
                                        <a href={{ route('siswa-detail', [$a->id]) }} class="btn btn-sm btn-outline-primary">
                                                <i class="icon-list"></i>
                                        </a>
...
@include('livewire.kesiswaan.siswa.add')
{{-- @include('livewire.kesiswaan.siswa.edit')
@include('livewire.kesiswaan.siswa.delete') --}}
