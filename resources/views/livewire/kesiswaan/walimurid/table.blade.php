                    ...
                    <table class="table align-items-center justify-content-center mb-0" style="font-size: 13px;">
                        <thead>
                            <tr>
                                ...
                                <th class="font-weight-bolder">No KTP</th>
                                <th class="font-weight-bolder">No Telp / WA</th>
                        ...
                        <tbody>
                            @foreach ($data as $a)
                                <tr>
                                    ...
                                    <td>{{ $a->no_telp }}</td>
                                    <td>
                                        <a wire:click.prevent="showModalDetail({{ $a }})"
                                                href="" class="btn btn-sm btn-outline-primary"><i
                                                    class="icon-list"></i></a>
...
@include('livewire.kesiswaan.walimurid.add')
@include('livewire.kesiswaan.walimurid.edit')
@include('livewire.kesiswaan.walimurid.delete')
@include('livewire.kesiswaan.walimurid.detail')
